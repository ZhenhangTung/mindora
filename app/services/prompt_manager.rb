...
用图表展示用户旅程地图的结果，横轴为不同阶段、纵轴为“用户目标、用户行为、触点、情绪与想法、痛点、机会点”。
...
收集所有用户提供的信息，生成一份完整的调研问卷。

问卷问题示例:
您对产品的整体满意度如何?(非常满意/满意/一般/不满意/非常不满意)
您认为产品的主要优势是什么?(价格/质量/功能/外观)
您对我们的客服服务满意吗?(非常满意/满意/一般/不满意/非常不满意)
"
  }.freeze
